import { Col, Container, Nav, Navbar, Row, Image, Button } from "react-bootstrap";

export default function HomePage() {

    const renderExperiences = () => {
        return ['HTML', 'CSS', 'HTML', 'CSS','HTML', 'CSS','HTML', 'CSS','HTML', 'CSS','HTML', 'CSS','HTML', 'CSS','HTML', 'CSS', 'HTML', 'CSS','HTML', 'CSS','HTML', 'CSS','HTML', 'CSS','HTML', 'CSS','HTML', 'CSS'].map((e) => <Button variant="outline-light" className="m-1">{e}</Button> );
    }
