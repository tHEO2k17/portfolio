                ...
                <Container>
                    <Row className="align-items-center min-vh-100 my-auto gx-5 text-light">
                        ...
                        <Col>
                            ...
                            <ProgressBar className="my-2" variant="info" now={70} label="Flutter" />
                            <ProgressBar>
                            ...
                            <ProgressBar className="my-2">
                                <ProgressBar variant="info" now={55} key={1} label="ReactJS" />
                                <ProgressBar variant="danger" now={30} key={2} label="AngularJS" />
                            </ProgressBar>
                        </Col>
                    </Row>
                </Container>
