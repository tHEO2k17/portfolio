                ...
                <Container>
                    <Row className="align-items-center min-vh-100 my-auto gx-5">
                        <Col>
                            ...
                            <h4>
                                Always up for a challenge, I have worked for lean start-ups and <br />
                                was a member of the first New Zealand start-up to attend Y Combinator, <br />
                                the largest start-up accelerator in the world. From there, <br />
                                I worked my way up to Art Director and Team Lead at Appster where <br />
                                I oversaw the design of 30+ mobile and desktop apps. Currently, <br />
