                    ...
                    <Row className="align-items-center min-vh-100 my-auto gx-5 text-light">
                        ...
                        <Col>
                            <ProgressBar>
                                ...
                                <ProgressBar variant="secondary" now={40} key={2} label="CSS" />
                                <ProgressBar variant="dark" now={10} key={3} label="Javascript" />
                                <ProgressBar variant="dark" now={10} key={3} label="Typescript" />
                            </ProgressBar>
                            <ProgressBar variant="dark" now={10} key={3} label="NodeJs" />
                            <ProgressBar variant="dark" now={10} key={3} label="Javascript" />
                        </Col>
                    </Row>
                </Container>
